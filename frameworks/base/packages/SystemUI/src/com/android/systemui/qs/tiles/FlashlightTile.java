...
import com.android.systemui.qs.tiles.FlashlightWrapper;
...
public class FlashlightTile extends QSTile<QSTile.BooleanState> implements
    ...
    private FlashlightWrapper wrapper;
    ...
    public FlashlightTile(Host host) {
        ...
        mFlashlightController.addListener(this);
                ...
                this.wrapper = new FlashlightWrapper(mContext);
    }
    ...
    protected void handleClick() {
		...
		stateLight = !stateLight;
            wrapper.toggleFlash(stateLight);            
        ...
        // Toast.makeText(mContext, "Project.Listick (k1ceargy)", Toast.LENGTH_SHORT).show();
